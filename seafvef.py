...
def provide_question_feedback(score, difficulty, is_exact_match, is_paraphrase, is_content_correct):
    feedback_messages = {
        ...
        'paraphrase': "Your answer is too similar to the question. Please provide a more detailed and informative answer.",
    }
...
def load_data(category):
    file_paths = {
        "frontend": r'C:\Users\MOUNI SRI\Downloads\frontend_difficulty (1).csv',
        "backend": r'C:\Users\MOUNI SRI\Downloads\backend_diff.csv'
    }
...
interview_feedback = conduct_interview_with_feedback(category="frontend", model=classification_model, tokenizer=classification_tokenizer, sbert_model=sbert_model)
